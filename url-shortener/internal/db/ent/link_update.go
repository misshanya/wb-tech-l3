...
func (_u *LinkUpdate) AddClickIDs(ids ...uuid.UUID) *LinkUpdate {
	_u.mutation.AddClickIDs(ids...)
	return _u
}

// AddClicks adds the "clicks" edges to the Click entity.
func (_u *LinkUpdate) AddClicks(v ...*Click) *LinkUpdate {
...
// ClearClicks clears all "clicks" edges to the Click entity.
func (_u *LinkUpdate) ClearClicks() *LinkUpdate {
	_u.mutation.ClearClicks()
	return _u
}

// RemoveClickIDs removes the "clicks" edge to Click entities by IDs.
func (_u *LinkUpdate) RemoveClickIDs(ids ...uuid.UUID) *LinkUpdate {
	_u.mutation.RemoveClickIDs(ids...)
	return _u
}

// RemoveClicks removes "clicks" edges to Click entities.
func (_u *LinkUpdate) RemoveClicks(v ...*Click) *LinkUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddClickIDs adds the "clicks" edge to the Click entity by IDs.
func (_u *LinkUpdateOne) AddClickIDs(ids ...uuid.UUID) *LinkUpdateOne {
	_u.mutation.AddClickIDs(ids...)
	return _u
}

// AddClicks adds the "clicks" edges to the Click entity.
func (_u *LinkUpdateOne) AddClicks(v ...*Click) *LinkUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearClicks clears all "clicks" edges to the Click entity.
func (_u *LinkUpdateOne) ClearClicks() *LinkUpdateOne {
	_u.mutation.ClearClicks()
	return _u
}

// RemoveClickIDs removes the "clicks" edge to Click entities by IDs.
func (_u *LinkUpdateOne) RemoveClickIDs(ids ...uuid.UUID) *LinkUpdateOne {
	_u.mutation.RemoveClickIDs(ids...)
	return _u
}

// RemoveClicks removes "clicks" edges to Click entities.
func (_u *LinkUpdateOne) RemoveClicks(v ...*Click) *LinkUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
