...
import (
	...
	linkrepo "github.com/misshanya/wb-tech-l3/url-shortener/internal/repository/link"
	linkservice "github.com/misshanya/wb-tech-l3/url-shortener/internal/service/link"
	linkhandler "github.com/misshanya/wb-tech-l3/url-shortener/internal/transport/http/v1/link"
...
func New(ctx context.Context, cfg *config.Config) (*App, error) {
	...
	linkRepo := linkrepo.New(a.entClient)
	linkService := linkservice.New(linkRepo)
	linkHandler := linkhandler.New(linkService, a.cfg.Server.PublicHost+apiPrefix)

	a.initGinext()

	apiGroup := a.ginextEngine.Group(apiPrefix)

	linkHandler.Setup(apiGroup)
