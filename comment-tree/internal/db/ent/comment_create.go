...
func (_c *CommentCreate) SetPath(v string) *CommentCreate {
	_c.mutation.SetPath(v)
	return _c
}

// SetNillablePath sets the "path" field if the given value is not nil.
func (_c *CommentCreate) SetNillablePath(v *string) *CommentCreate {
	if v != nil {
		_c.SetPath(*v)
	}
	return _c
...
func (_c *CommentCreate) AddChildIDs(ids ...uuid.UUID) *CommentCreate {
